create database newyorkRestaurant;
use newyorkRestaurant;
...
INSERT INTO restaurants VALUES (50010994, "Via Vai","3109",'23RD AVE','Queens','11105','9173765356');
...
INSERT INTO restaurants VALUES (50080764, "PLANTSHED CAFE","1",'PRINCE STREET','Manhattan','10012','212662444');
...
INSERT INTO Inspection VALUES (1,'Cycle Inspection / Initial Inspection','2016/11/16', 'A', 10, 50010994);
INSERT INTO Inspection VALUES (2,'Pre-permit (Operational) / Initial Inspection','2020/3/11', 'N', 13, 50098104);
INSERT INTO Inspection VALUES (3,'Cycle Inspection / Re-inspection','2018/2/27', 'A', 11, 41275941);
...
INSERT INTO Violation VALUES (11,'10F', "2016/11/16", "Non-food contact surface improperly constructed. Unacceptable material used. 
...
accessibility for cleaning on all sides, above and underneath the unit.",
 ...
 INSERT INTO Violation VALUES (12,'06C', "2020/03/11", "Food not protected from potential source of contamination during storage, preparation, 
 transportation, display or service.",
 "Violations were cited in the following area(s)",50098104);
 INSERT INTO Violation VALUES (13,'02H', "2018/02/27", "Food not cooled by an approved method whereby the internal product temperature
 ...
 INSERT INTO Violation VALUES (14,'10B', "2017/08/07", "Plumbing not properly installed or maintained; anti-siphonage or backflow prevention 
 ...
 INSERT INTO Violation VALUES (15,'10F', "2018/08/27", "Non-food contact surface improperly constructed. Unacceptable material used. Non-food 
 ...
 INSERT INTO Violation VALUES (16,'10B', "2018/09/11", "Plumbing not properly installed or maintained; anti-siphonage or backflow prevention 
 device not provided where required; equipment or floor not properly drained; sewage disposal system in disrepair or not functioning properly.",
 "Violations were cited in the following area(s)",50075871);
 INSERT INTO Violation VALUES (17,'02G', "2016/07/09", "Cold food item held above 41º F (smoked fish and reduced oxygen packaged foods 
 above 38 ºF) except during necessary preparation.",
 "Violations were cited in the following area(s)",41324345);
INSERT INTO Violation VALUES (18,'10F', "2018/04/02", "Non-food contact surface improperly constructed. Unacceptable material used. 
...
INSERT INTO Violation VALUES (19,'10B', "2019/07/19", "Plumbing not properly installed or maintained; anti-siphonage or backflow prevention
   device not provided where required; equipment or floor not properly drained; sewage disposal system in disrepair or not functioning properly.",
 "Violations were cited in the following area(s)",50081691);
INSERT INTO Violation VALUES (20,'10H', "2018/10/09", "Proper sanitization not provided for utensil ware washing operation.",
 "Violations were cited in the following area(s)",50080764);
 INSERT INTO Violation VALUES (21,'10F', "2019/11/22", "Non-food contact surface improperly constructed. Unacceptable material used. Non-food contact 
 ...
 INSERT INTO Violation VALUES (22,'08A', "2022/01/04", "Facility not vermin proof. Harborage or conditions conducive to attracting vermin to the premises and/or allowing vermin to exist.",
 "Violations were cited in the following area(s)",40725853);
 INSERT INTO Violation VALUES (23,'10E', "2019/07/22", "Accurate thermometer not provided in refrigerated or hot holding equipment.",
 "Violations were cited in the following area(s)",50093375);
  INSERT INTO Violation VALUES (24,'10F', "2021/08/06", "Non-food contact surface improperly constructed. Unacceptable material used. 
...
INSERT INTO Violation VALUES (25,'06C', "2019/03/08", "Food not protected from potential source of contamination during storage, 
   preparation, transportation, display or service.",
 "Violations were cited in the following area(s)",50015634);
 INSERT INTO Violation VALUES (26,'20D', "2018/06/12", "“Choking first aid” poster not posted. “Alcohol and pregnancy” warning sign not posted.
 ...
 "Violations were cited in the following area(s)",50063463);
  INSERT INTO Violation VALUES (27,'08A', "2019/11/25", "“Facility not vermin proof. Harborage or conditions conducive to attracting vermin 
  to the premises and/or allowing vermin to exist.",
 "Violations were cited in the following area(s)",41708320);
 INSERT INTO Violation VALUES (28,'10B', "2019/09/25", "Plumbing not properly installed or maintained; anti-siphonage or backflow prevention 
 device not provided where required; equipment or floor not properly drained; sewage disposal system in disrepair or not functioning properly.",
 "Violations were cited in the following area(s)",50088888);
  INSERT INTO Violation VALUES (29,'08A', "2021/09/30", "Facility not vermin proof. Harborage or conditions conducive to attracting vermin to the premises and/or allowing vermin to exist.",
 "Violations were cited in the following area(s)",50094030);
 INSERT INTO Violation VALUES (30,'03A', "2021/09/30", "Food from unapproved or unknown source or home canned. Reduced oxygen packaged (ROP) 
 ...
 /* a */
SELECT DBA,CONCAT(BUILDING,',',STREET) 
FROM RESTAURANTS;

/*c*/
SELECT CAMIS,inspectionID, score 
FROM inspection
WHERE SCORE<90;
...
select inspectionDate ,count(inspectiondate) as inspectioncounts
from inspection
group by inspectionDate
order by inspectioncounts desc;

#i.	What restaurant has the most inspections?
SELECT DBA,COUNT(inspecttype) as most_inspection
FROM RESTAURANTS 
INNER JOIN inspection 
on inspection.CAMIS = restaurants.Camis
GROUP BY restaurants.Camis
order by most_inspection desc;

# j. What is the average score for each Starbucks, Baskin Robbins, and Sbarro?
SELECT DBA,AVG(SCORE) as avgscore
FROM restaurants as r
Inner Join 
inspection as i
on i.camis=r.camis
WHERE DBA in ('Starbucks','Burger king','GALANGA THAI COOKING')
Group by DBA
